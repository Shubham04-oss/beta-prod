module github.com/synq/ops-api
...
require (
	...
	github.com/synq/pkg v0.0.0-00010101000000-000000000000
	github.com/unified-to/unified-go-sdk v0.36.81
...
replace github.com/synq/pkg => ../../pkg
